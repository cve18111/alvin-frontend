      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Vorteile</h2>
            <p className="text-xl text-gray-600">Die Zufriedenheit der Nutzer steht an erster Stelle, deswegen zeichnet sich alvin in folgenden Punkten besonders aus.</p>
          </div>

          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-3 md:grid-cols-1 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Neueste Technologien</h4>
              <p className="text-gray-600 text-center">alvin nutzt die neuestmöglichen Technologien um dem User das beste Erlebnis zu bieten.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Enorme Flexibilität</h4>
              <p className="text-gray-600 text-center">alvin lässt sich in jedem Browser öffnen, egal ob am Handy oder am PC.</p><br></br>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Hohe Sicherheit</h4>
              <p className="text-gray-600 text-center">Deine Daten werden bei uns sicher verschlüsselt.</p><br></br>
            </div>
